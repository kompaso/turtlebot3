...
class Task2:
    ...
    def __init__(self):
        ...
        "Controllers"
        self.pose_controller = PID([0.5, 0.5, 2.5], 
                                   [0.0, 0.0, 0.0],
                                   [0.1, 0.1, 0.1])
    ...
    def spin(self):
        ...
        self.time_start_trajectory = 0.0
        while not rospy.is_shutdown():
            ...
            if t < 1. * time_step:
                ...
                i = 0
                #self.time_start_trajectory = rospy.get_time()
            
            else:
                if len(self.cart_trajectory.poses) > 1:
                    if i < len(self.cart_trajectory.poses) - 2:
                        goal_pose = self.cart_trajectory.poses[i]
                        i = i + 1
                        print(i,  goal_pose.x, goal_pose.y)
                        self.pose_des = self.transform_pose([goal_pose.x, goal_pose.y, 2.0])
